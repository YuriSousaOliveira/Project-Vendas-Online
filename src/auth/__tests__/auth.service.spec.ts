...
import { loginUserEntityMock } from '../__mocks__/loginUser.mock';
...
describe('AuthService', () => {
  ...
  it('should return user if password and email valid', async () => {
    const user = await service.login(loginUserEntityMock);
    expect(user).toEqual({
      accessToken: jwtMock,
